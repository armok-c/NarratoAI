...
| `cargo test --lib prompt::` | All 57 passed |
| `plot_analysis_v1.0.md` exists, >= 50 lines | 66 lines ✓ |
| Contains `${subtitle_content}` | ✓ |
| `script_generation_v2.0.md` exists, >= 150 lines | 267 lines ✓ |
| Contains `${drama_name}` | ✓ (2 occurrences) |
| Contains `${plot_analysis}` | ✓ |
| Contains `${subtitle_content}` | ✓ |
| `register.rs` grep "plot_analysis" >= 3 | 6 references ✓ |
| Short_drama_narration has 2 names (3 versions) | plot_analysis v1.0 + script_generation v1.0 + v2.0 ✓ |
